...
if [ -f ${plugin_file} ];then
    ...
    wget https://raw.githubusercontent.com/luolixman/tool/main/bt/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/luolixman/tool/main/bt/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/luolixman/tool/main/bt/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/luolixman/tool/main/bt/repair.json
...
wget -q https://raw.githubusercontent.com/luolixman/tool/main/bt/bt.js -O $JS_file;
